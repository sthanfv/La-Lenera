      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <Reveal>
            <div className="mb-8">
                <div className="badge-stamp text-xs md:text-sm">
                    Proveedor Local · Trabajo Diario
                </div>
            </div>
        </Reveal>
        ...
        <Reveal delay="200">
            <p className="font-headline text-lg md:text-2xl text-gray-400 uppercase tracking-[0.4em] mb-12">
                Leña para asaderos y parrillas
            </p>
        </Reveal>
        ...
        <Reveal delay="300">
            <div className="max-w-xl mx-auto mb-12">
                <p className="text-gray-300 text-lg font-light leading-relaxed">
                    Fuego parejo, sin improvisar. <br/>
                    <span className="text-white font-medium uppercase text-sm tracking-widest mt-2 block">Cuando el fuego es tu herramienta, necesitas leña que responda.</span>
                </p>
            </div>
        </Reveal>
